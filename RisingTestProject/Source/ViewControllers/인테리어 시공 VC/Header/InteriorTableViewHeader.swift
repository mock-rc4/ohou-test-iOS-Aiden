...
final class InteriorTableViewHeader: UITableViewHeaderFooterView {
    ...
    override func awakeFromNib() {
        ...
        // 광고 이미지 가져오기
        imageArray = Constant.interiorBannerImage
...
extension InteriorTableViewHeader: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension InteriorTableViewHeader: UICollectionViewDelegateFlowLayout {
...
extension InteriorTableViewHeader {
