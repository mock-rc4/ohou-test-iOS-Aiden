//
//  StoreHomeTableViewHeader.swift
//  RisingTestProject
//
...
class StoreHomeTableViewHeader: UITableViewHeaderFooterView {
    ...
    override func awakeFromNib() {
        ...
        collectionView.register(UINib(nibName: "CommercialBannerCell", bundle: nil), forCellWithReuseIdentifier: "CommercialBannerCell")
...
extension StoreHomeTableViewHeader: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension StoreHomeTableViewHeader: UICollectionViewDelegateFlowLayout {
...
extension StoreHomeTableViewHeader {
