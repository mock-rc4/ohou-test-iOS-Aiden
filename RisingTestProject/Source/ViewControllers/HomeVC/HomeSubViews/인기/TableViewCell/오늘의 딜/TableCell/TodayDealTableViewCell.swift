...
class TodayDealTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        todayDealCollectionView.register(UINib(nibName: "PopularityCollectionViewHeaderCell", bundle: nil), forCellWithReuseIdentifier: "PopularityCollectionViewHeaderCell")
        ...
        todayDealCollectionView.collectionViewLayout = createCompositionalLayout()
    }
...
extension TodayDealTableViewCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if indexPath.section == 0 {
            ...
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "TodayDealCollectionViewCell", for: indexPath) as? TodayDealCollectionViewCell else {
                return UICollectionViewCell()
            }
            // MARK: - Cell 업데이트 필요
//            cell.updateCell(<#T##leftDays: Int##Int#>, <#T##info: String##String#>, <#T##rate: String##String#>)
...
extension TodayDealTableViewCell {
    fileprivate func createCompositionalLayout() -> UICollectionViewLayout {
        ...
        let layout = UICollectionViewCompositionalLayout {
            ...
            if sectionIndex == 1 {
                ...
                // 그룹 사이즈
                let groubSize = NSCollectionLayoutSize(widthDimension: .fractionalWidth(1.0), heightDimension: .fractionalWidth(1/1.8))
