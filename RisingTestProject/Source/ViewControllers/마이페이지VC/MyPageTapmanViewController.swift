...
final class MyPageTapmanViewController: TabmanViewController {
    ...
    override func viewDidLoad() {
        ...
        viewControllers = [
            ...
            storyboard?.instantiateViewController(withIdentifier: "MyShoppingViewController") as! MyShoppingViewController,
        ]
        ...
        bar.layout.alignment = .leading   // 정렬 (왼, 오, 가운데)
...
extension MyPageTapmanViewController: PageboyViewControllerDataSource, TMBarDataSource {
    ...
    func barItem(for bar: TMBar, at index: Int) -> TMBarItemable {
        switch index {
        case 0:
            return TMBarItem(title: "프로필", badgeValue: nil)
        case 1:
            return TMBarItem(title: "나의쇼핑", badgeValue: nil)
        default:
